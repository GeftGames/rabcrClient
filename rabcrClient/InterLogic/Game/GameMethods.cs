...
namespace rabcrClient {
    ...
    static class GameMethods {
		...
		public static bool IsSelectedKnife(ushort id) 
            ...
            public static bool IsLeavesOrBranches(ushort id) => id switch {
                (ushort)BlockId.AcaciaLeaves => true,
                (ushort)BlockId.AppleLeaves => true,
                (ushort)BlockId.AppleLeavesWithApples => true,
                (ushort)BlockId.AppleLeavesBlossom => true,
                ...
                (ushort)BlockId.OakBranchesSnow => true,
                ...
                (ushort)BlockId.ChristmasBall => true,
                (ushort)BlockId.ChristmasBallBlue => true,
                (ushort)BlockId.ChristmasBallLightGreen => true,
                (ushort)BlockId.ChristmasBallOrange => true,
                (ushort)BlockId.ChristmasBallPink => true,
                (ushort)BlockId.ChristmasBallPurple => true,
