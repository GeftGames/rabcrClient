...
public class GColor : Control{
    ...
    protected override void OnPaint(PaintEventArgs e) {
        ...
        if (selected) {
            ...
            b= new LinearGradientBrush(ClientRectangle, Color.White/*Color.FromArgb(alpha-20, alpha-20, alpha-20)*/,Color.Black/* Color.FromArgb(alpha-40-20, alpha-40-20, alpha-40-20)*/, 60f);
        } else {
